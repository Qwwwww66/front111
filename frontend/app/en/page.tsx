          ...
          <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-semibold leading-tight lg:text-5xl space-y-2">
                <span className="block">Multi-Agent Workspace for Clean Water</span>
                <span className="block">AI-Powered Water Quality Risk Control</span>
              </h1>
              <p className="text-base text-white/70 lg:text-lg">
                Powered by Qwen + CrewAI multimodal intelligence to acquire data, issue risk alerts,
                plan mitigation strategies, orchestrate on-site actions, and optimize recommendations
                with a user-friendly, data-driven decision platform.
              </p>
              <div className="flex flex-wrap gap-3 text-[13px] uppercase tracking-widest text-white/60">
                {["Monitoring", "Expert Review", "Emergency Response", "Field Orchestration", "Strategy Optimization"].map((item) => (
                  <span
                    key={item}
